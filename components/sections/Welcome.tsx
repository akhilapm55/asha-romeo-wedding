...
export default function Welcome() {
  ...
  return (
    ...
    >
      ...
      <PalmLeaf className="pointer-events-none absolute -left-6 top-16 w-28 rotate-[20deg] text-palm/20 sm:w-40" />
      <PalmLeaf className="pointer-events-none absolute -right-6 bottom-16 w-28 -rotate-[24deg] text-olive/20 sm:w-40" />
